  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col gap-10 pb-16">
        ...
        {/* Header */}
        <div>
          <p className="tracking-[0.25em] uppercase mb-3" style={{ fontSize: '11px', color: 'var(--solm-text-3)' }}>
            Legal
          </p>
          <h1 style={{ fontSize: '32px', fontWeight: 300, letterSpacing: '-0.02em', color: 'var(--solm-text-1)', marginBottom: '8px' }}>
            Privacy at Solm
          </h1>
          <p style={{ fontSize: '13px', color: 'var(--solm-text-3)', fontWeight: 300 }}>
        ...
        <p style={{ fontSize: '15px', fontWeight: 300, color: 'var(--solm-text-2)', lineHeight: 1.7 }}>
          ...
          <a href="mailto:ozgurmonkul@gmail.com" style={{ color: 'var(--solm-text-3)', textDecoration: 'underline', textUnderlineOffset: '4px' }}>
        ...
        <Section title="What we collect">
          <ul className="flex flex-col gap-4">
            {[
              ...
              <li key={label} style={{ fontSize: '15px', fontWeight: 300, color: 'var(--solm-text-2)', lineHeight: 1.7 }}>
                <span style={{ color: 'var(--solm-text-3)' }}>{label} — </span>{desc}
              </li>
            ))}
          </ul>
          <p className="mt-4" style={{ fontSize: '13px', fontWeight: 300, color: 'var(--solm-text-3)', lineHeight: 1.6 }}>
        ...
        <Section title="Why we collect it">
          <ul className="flex flex-col gap-3">
            {[
              ...
              <li key={item} style={{ fontSize: '15px', fontWeight: 300, color: 'var(--solm-text-2)', lineHeight: 1.7 }}>
                {item}
              </li>
            ))}
          </ul>
          <p className="mt-4" style={{ fontSize: '14px', fontWeight: 300, color: 'var(--solm-text-3)', lineHeight: 1.6 }}>
        ...
        <Section title="Who else sees your data">
          <p className="mb-6" style={{ fontSize: '15px', fontWeight: 300, color: 'var(--solm-text-2)', lineHeight: 1.7 }}>
            To run Solm, we use a small set of third-party services. Each one sees a specific slice of your data:
          </p>
          <div className="rounded-2xl overflow-hidden" style={{ border: '1px solid var(--solm-border)' }}>
            {[
              ...
              <div
                ...
                style={i < arr.length - 1 ? { borderBottom: '1px solid var(--solm-border)' } : undefined}
              >
                <p style={{ fontSize: '13px', color: 'var(--solm-text-3)', fontWeight: 400 }}>{service}</p>
                <p style={{ fontSize: '12px', fontWeight: 300, color: 'var(--solm-text-4)', lineHeight: 1.5 }}>{data}</p>
                <p style={{ fontSize: '11px', color: 'var(--solm-text-5)', letterSpacing: '0.05em' }}>{location}</p>
              </div>
            ))}
          </div>
          <p className="mt-5" style={{ fontSize: '13px', fontWeight: 300, color: 'var(--solm-text-3)', lineHeight: 1.7 }}>
        ...
        <Section title="Your rights">
          <p className="mb-4" style={{ fontSize: '15px', fontWeight: 300, color: 'var(--solm-text-2)', lineHeight: 1.7 }}>
        ...
        <Section title="Changes to this policy">
          ...
          <p className="mt-4" style={{ fontSize: '13px', color: 'var(--solm-text-5)', fontWeight: 300 }}>
