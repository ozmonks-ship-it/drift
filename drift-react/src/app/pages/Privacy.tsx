      ...
      <div className="flex-1 flex flex-col gap-10 pb-16">
        ...
        <Section title="What we collect">
          <ul className="flex flex-col gap-4">
            {[
              ...
              [
                'Your tasks',
                'The title of each task you add. We do not ask for or read attachments, photos, or anything outside the title field.',
              ],
              [
                'Your personal context',
                'The priorities, work style, focus days and any free-text notes you provide during onboarding (or later in Settings). This is what helps Solm pick the right next thing for you.',
              ],
              [
                'Usage data',
                'Pages you visit inside the app, actions you take (e.g. starting a task, marking it done), and a session recording of how you interact with the screen. Recordings have all text inputs masked, so the words you type into Solm are not visible in them.',
              ],
              [
                'Technical data',
                'Device type, browser, approximate location (city-level, from your IP), and basic crash/error logs.',
              ],
            ].map(([label, desc]) => (
              <li
                key={label}
        ...
        <Section title="Who else sees your data">
          ...
          >
            ...
            don't use Solm during this beta.
          </p>
        </Section>
        ...
        <Section title="How long we keep it">
          <ul className="flex flex-col gap-3">
            {[
              [
                'Account, tasks, personal context',
                'Kept while your account exists. Deleted from Supabase within 7 days of an account deletion request.',
              ],
              ['Usage analytics', 'Kept by PostHog for up to 12 months, then deleted automatically.'],
              [
                'Session recordings',
                'Kept by PostHog for up to 30 days, then deleted automatically.',
              ],
        ...
        <Section title="Security">
          ...
          >
            ...
            it, in line with Australia's Notifiable Data Breaches scheme.
          </p>
        </Section>
